...
if /i "%1"=="update" (
    echo openclaw is managed by ClawPlus ^(bundled version^).
    echo.
    echo To update openclaw, update ClawPlus:
    echo   Open ClawPlus ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=ClawPlus
"%~dp0..\..\ClawPlus.exe" "%~dp0..\openclaw\openclaw.mjs" %*
